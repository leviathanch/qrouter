               ...
               int objc, Tcl_Obj *CONST objv[])
{
    ...
    static char *subCmds[] = {
	"debug", "mask", "route", "force", "step", "overhead", "effort", NULL
    };
    enum SubIdx {
	DebugIdx, MaskIdx, RouteIdx, ForceIdx, StepIdx, OverHeadIdx, EffortIdx
    };
